...
默认 SA acceleration 是 `lcp_suffix_link`，持久化 SA+ISA+LCP。CHILD 保留给 suffix-tree 风格导航、未来 MUM/MAM 和重复区研究，但当前 exact 和 right-maximal exact match 自动选择都不会消费 CHILD。
