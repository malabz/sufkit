...
**Status:** Archived 0.2.0 development benchmark evidence. This result
validates correctness and the expected memory shape; it is not a release-wide
or large-genome speed claim.
