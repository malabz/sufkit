...
compatibility with the existing ISA/LCP/CHILD/MEM pipeline. divsufsort phase
...
while exact and MEM checksums must agree across every K. Sampling compacts the
