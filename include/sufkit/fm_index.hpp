...
struct FmBatchOptions {
    ...
    /** Active query states per chunk; zero selects 16, valid explicit range 1–256. */
...
public:
     ...
     * @param patterns Non-empty A/C/G/T patterns; one invalid value rejects all.
    ...
    /**
     * Count patterns in input order with fixed-width interleaving. @since Unreleased
     * @param patterns Non-empty A/C/G/T patterns; one invalid value rejects all.
